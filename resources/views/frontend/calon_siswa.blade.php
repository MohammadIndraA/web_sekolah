...
@section('title', 'Calon Perserta Didik Baru')
@section('style')
    <style>
        .contact-add {
            padding: 20px;
            ...
            <div class="row">
                    ...
                    <div class="contact-contents text-center">
                        <div class="single-contact">
                            <div class="contact-add">
                                ...
                                <ul>
                                    <li>IZAJAH KETERANGAN LULUS</li>
                                    <li>(IZAJAH DI SERAHKAN SETELAH TERBIT)</li>
                                    <li>FC NISN</li>
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                    <div class="reply-area">
                        ...
                        <p>Formulir untuk mengumpulkan data calon peserta didik baru, mencakup informasi pribadi, riwayat
                            pendidikan.</p>
                        @if (session('success'))
                        ...
                        <form action="{{ route('siswa.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="kategori" id="kategori" value="Calon Peserta Didik">
