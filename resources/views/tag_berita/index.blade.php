...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Tag Berita</h4>
            </div>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-4">
                            <a href="#" class="btn btn-primary mb-2"
                                onClick="addData('{{ route('tag-berita.store') }}')"><i
    ...
    <x-modal>
        <div class="modal-body">
            ...
            <div class="row mb-1">
                <label for="name" class="col-3 col-form-label">Nama Tag <sop class="text-danger">*</sop>
                </label>
                <div class="col-9">
...
@section('script')
    <script>
        ...
        function editFunc(id) {
            ...
            let url = `{{ route('tag-berita.update', 'ids') }}`
            $('#myForm').attr('action', url.replace('ids', id));
            $('#myForm').data('type', 'edit');

            $.ajax({
                type: "GET",
                url: "{{ route('tag-berita.edit') }}",
                data: {
                    id: id
                },
                dataType: 'json',
