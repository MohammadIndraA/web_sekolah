...
@section('content')
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-4">
                            <a href="#" class="btn btn-primary mb-2"
                                onClick="addData('{{ route('jurusan.store') }}')"><i class="mdi mdi-plus-circle me-2"></i>
                                Tambah Data</a>
                        </div>
                        {{-- @endcan --}}
                    </div>
    ...
    <x-modal>
        <div class="modal-body">
            ...
            <div class="row mb-1">
                <label for="name" class="col-3 col-form-label">Nama Jurusan <sop class="text-danger">*</sop>
                </label>
                <div class="col-9">
...
@section('script')
    <script>
        ...
        function editFunc(id) {
            ...
            let url = `{{ route('jurusan.update', 'ids') }}`
