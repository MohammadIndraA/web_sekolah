...
@section('content')
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-4">
                            <a href="#" class="btn btn-primary mb-2"
                                onClick="addData('{{ route('daftar-sekolah.store') }}')"><i
    ...
    <x-modal>
        <div class="modal-body">
            ...
            <div class="row mb-1">
                <label for="name" class="col-3 col-form-label">Nama Sekolah <sop class="text-danger">*</sop>
                </label>
                <div class="col-9">
            ...
            <div class="row mb-1">
                <label for="deskripsi" class="col-3 col-form-label">Keterangan <sop class="text-danger">*</sop>
                </label>
                <div class="col-9">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('daftar-sekolah.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        searchable: false,
                        sortable: false
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            if (data == 'aktif') {
                                return `<span class="badge bg-success">Sudah Daftar Ulang</span>`;
                            } else {
                                return `<span class="badge bg-warning">Belum Daftar Ulang</span>`;
                            }
                        }
                    },
                    {
        ...
        function deleteFunc(id) {
            if (confirm("Delete Record?") == true) {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('daftar-sekolah.delete') }}",
                    data: {
                        id: id
                    },
                    dataType: 'json',
